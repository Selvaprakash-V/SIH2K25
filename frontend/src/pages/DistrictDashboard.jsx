      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white">
            District Dashboard - {user?.district}, {user?.state}
          </h1>
          <p className="text-gray-600 dark:text-gray-400 mt-2">
            Managing villages and resources in {user?.district} district
          </p>
          <div className="mt-2 text-sm text-blue-600 dark:text-blue-400">
            <span className="font-medium">Role:</span> District Officer
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            ...
            <ResponsiveContainer width="100%" height={300}>
              <PieChart>
                <Pie
                  data={getVillageDistribution().slice(0, 8)} // Show top 8 villages
                  cx="50%"
                  cy="50%"
                  labelLine={false}
                  ...
                  dataKey="value"
                >
                  {getVillageDistribution().slice(0, 8).map((entry, index) => (
            ...
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Explore villages in your district
                </p>
              </div>
            </div>
          </Link>
          ...
          <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
            <div className="flex justify-between items-center">
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
                District Problems & Gaps
              </h3>
              <div className="flex space-x-2">
                {[
                  { label: 'All', value: 'all' },
                  { label: 'By Village', value: 'village' },
                ...
                {filteredProblemData.length === 0 && (
                  <tr>
                    <td colSpan="6" className="px-6 py-4 text-center text-sm text-gray-500 dark:text-gray-400">
                      No problems detected in your district
                    </td>
                  </tr>
                )}
              </tbody>
        ...
        {/* Problem Details Modal with Project Creation */}
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-2xl w-full mx-4 max-h-screen overflow-y-auto">
              <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
                  Problem Info & Submit Project Details
                </h3>
                <button
